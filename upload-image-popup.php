<div id="newImagePopup" class="upload-image-modal">

		<!-- Modal content -->
			<div class="upload-image-content">
			<a href="javascript:void(0);" id="close-uploadImage" class="button medium icon fa-times" style="height:50px;float:left;;width:60px;font-size:30px;padding:0px;padding: 3% auto;"></a>
